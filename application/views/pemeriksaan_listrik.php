                ...
                ?>
                        ...
                        <table class="table table-bordered2 table-striped display no-wrap text-muted" style="width:100%; height:100%;">
                            ...
                            <tr>
                                ...
                                <td colspan='2'> 
                                    : Pemeriksaan / Maintenance Listrik
                                </td>
                        ...
                        <table class="table table-striped table-bordered2 display no-wrap"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 text-muted px-2 py-4 font-12">Identifikasi instalasi listrik melalui drawing</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 text-muted px-2 py-4 font-12" rowspan="2" >Pemeriksaan kondisi fisik peralatan listrik pada panel listrik, sambungan/ klem</td>
                                                ...
                                                3. Menggunakan rubber gloves, safety shoes				
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 text-muted px-2 py-4 font-12"  rowspan="2">Memeriksa kesesuaian kondisi pemasangan peralatan terhadap beban yang digunakan sesuai dengan persyaratan peraturan pemerintah	 </td>

                                                <td class="border-top-1 px-2 py-4">1. Aliran listrik </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 px-2 py-4"> 1. Menggunakan pakaian kerja (wearpack), safety helmet, hand gloves, safety shoes, safety glass							
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 text-muted px-2 py-4 font-12" rowspan="2">Mengukur tegangan kerja yang ada antar fasa dan terhadap netral yang disyaratkan. (R-S),(R-T),(S-T),(R-N),(S-N),(T-N) </td>
                                                ...
                                                1. Membaca dan menerapkan SOP pekerjaan instalasi listrik <br>			
                                                2. Menerapkan prosedur LOTO	<br>		
                                                3. Menggunakan peralatan pemeriksaan yang memenuhi standar	<br>			
                                                4. Pastikan objek pada kondisi aman untuk diperiksa	<br>		
                                                5. Menggunakan rubber gloves				
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 text-muted px-2 py-4 font-12" rowspan="1">Melakukan uji pengukuran tahanan isolasi menggunakan alat Insulation Tester dengan aliran listrik harus dimatikan  dan harus tanpa beban peralatan listrik.(Harus dilepaskan dari stop kontak listrik).</td>
                                                ...
                                                1. Membaca dan menerapkan SOP pekerjaan instalasi listrik	<br>			
                                                2. Menerapkan prosedur LOTO	<br>		
                                                3. Pastikan objek pada kondisi aman untuk diperiksa	<br>			
                                                4. Menggunakan peralatan pemeriksaan yang memenuhi standar				
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 text-muted px-2 py-4 font-12" rowspan="1">Mendokumentasikan objek yang telah diperiksa sesuai kondisi aktual.</td>
                                                <td class="border-top-1 px-2 py-4"> 1. Permukaan tidak rata/stabil</td>
                                                <td class="border-top-1 px-2 py-4"> 1. Terpelset/Tersandung <br> /Terjatuh</td>
