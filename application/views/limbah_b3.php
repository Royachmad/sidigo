                        ...
                        <table class="table table-striped table-bordered2 display no-wrap"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 text-muted px-2 py-4 font-12" rowspan="4" >Persiapan Pengangkutan</td>

                                                <td class="border-top-1 px-2 py-4"> 
                                                1. Koordinasi buruk selama pengangkutan
                                                 </td>
                                                 <td class="border-top-1 px-2 py-4"> 
                                                 1. Barang jatuh menimpa pekerja    
                                                 </td>
                                                <td class="border-top-1 px-2 py-4" >
                                                1. Membuat lifting plan dan mensosialisasikannya ke pekerja	<br>		
                                                2. Menggunakan APD (safety helmet, rubber gloves, gas masker, safety shoes, safety glasses dan safety clothes)						
                                                </td>			
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                2. Area tidak steril
                                                 ...
                                                 <td class="border-top-1 px-2 py-4"> 
                                                 1. Mengganggu proses pengangkutan, <br> pekerja bisa tertimpa material
                                                 </td>
                                                <td class="border-top-1 px-2 py-4" >
                                                1. Memasang barikade di area pengangkutan		
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 text-muted px-2 py-4 font-12"  rowspan="2">Pengangkutan </td>

                                                <td class="border-top-1 px-2 py-4">1. Koordinasi buruk selama pengangkutan</td>
                                                <td class="border-top-1 px-2 py-4">1. Material mengalami swing / mengayun</td>

                                                <td class="border-top-1 px-2 py-4"> 
                                                1. Terdapat petugas flogger dan juga radio handy talky untuk komunikasi
                                                </td>						
                                            </tr>

                                            <tr>
                                                <td class="border-top-1 px-2 py-4">2. Material tercecer / tumpah  </td>
                                                <td class="border-top-1 px-2 py-4">1. Terhirup/ terkena kulit </td>
                                                <td class="border-top-1 px-2 py-4"> 1. Menggunakan APD (safety helmet, rubber gloves, gas masker, safety shoes, safety glasses dan safety clothes)			
                                                <br> 2. Lakukan pengangkutan dengan hati - hati					
                                                </td>
                                            </tr>
