                ...
                ?>
                        ...
                        <table class="table table-bordered2 table-striped display no-wrap text-muted" style="width:100%; height:100%;">
                            ...
                            <tr>
                                ...
                                &nbsp  4. Gas masker, Dust masker	<br>	
                                </td>
                                <td>
                                &nbsp 5. Earplug, Earmuff	<br>
                                &nbsp 6. Safety glass, Face Shield <br>	
                                &nbsp 7. Coverall, Safety Clothes	
                        ...
                        <table class="table table-striped table-bordered2 display no-wrap"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="border-top-1 text-muted px-2 py-4 font-12" rowspan="2">1</td>

                                                <td class="border-top-1 text-muted px-2 py-4 font-12" rowspan="2">Survey Lokasi bersama customer, kontraktor, spv dan pekerja</td>

                                                <td class="border-top-1 px-2 py-4"> 1. Permukaan tidak rata/stabil  </td>
                                                <td class="border-top-1 px-2 py-4"> 1. Terpleset <br> /Tersandung <br>/terjatuh </td>
                                                <td class="border-top-1 px-2 py-4"> 1. Menggunakan wearpack,  safety shoes, safety helmet </td>
                                            </tr>
                                            <tr>
                                                <td class="border-top-1 px-2 py-4"> 2. Tersebar ke seluruh komunitas </td>
                                                <td class="border-top-1 px-2 py-4"> 1. Komunitas terganggu </td>
                                                <td class="border-top-1 px-2 py-4"> 1. Pemberitahuan kepada penduduk sekitar  </td>    
                                            </tr>
                                            ...
                                            <tr>
                                                <td class="border-top-1 text-muted px-2 py-4 font-12" rowspan="2">3</td>

                                                <td class="border-top-1 text-muted px-2 py-4 font-12" rowspan="2" >Persiapan Material</td>

                                                <td class="border-top-1 px-2 py-4"> 
                                                1. Bahan kimia tumpah <br>
                                                 </td>
                                                 <td class="border-top-1 px-2 py-4">1. terhirup/ terkena kulit</td>
                                                <td class="border-top-1 px-2 py-4" >
                                                1. Menggunakan APD (safety helmet, rubber gloves, gas masker, safety shoes, face shield, ear plug dan safety clothes)				  
                                                </td>			
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 px-2 py-4" > 
                                                2. Personil tidak kompeten
                                                 </td>
                                                 <td class="border-top-1 px-2 py-4"> 2. Kesalahan pemilihan/ pengambilan bahan kimia </td>
                                                <td class="border-top-1 px-2 py-4" >
                                                1. Bekerja lebih fokus, personil memiliki ijin / sertifikasi <br>				
                                                2. Check labeling / MSDS / baca label pada kemasan / botol				
						
                                                </td>
                                            </tr>

                                            <tr>
                                                <td class="border-top-1 text-muted px-2 py-4 font-12"  rowspan="1">4</td>

                                                <td class="border-top-1 text-muted px-2 py-4 font-12"  rowspan="1">Mobilisasi</td>

                                                <td class="border-top-1 px-2 py-4">1. Bahan kimia tumpah  </td>
                                                <td class="border-top-1 px-2 py-4">1. terhirup/ terkena kulit</td>

                                                <td class="border-top-1 px-2 py-4"> 
                                                1. Memasukkan dalam kontainer	<br>			
                                                2. Menggunakan APD (safety helmet, rubber gloves, gas masker, safety shoes, face shield, ear plug dan safety clothes) <br>				
                                                3. Persiapkan alat penyerap untuk penanggulangan tumpahan di jalan seperti absorbent				
			
                                            </tr>

                                            <tr>
                                                <td class="border-top-1 text-muted px-2 py-4 font-12" rowspan="6">5</td>

                                                <td class="border-top-1 text-muted px-2 py-4 font-12" rowspan="6">Pelaksanaan Fogging / Pengasapan </td>
                                            ...
                                            <tr>
                                                <td class="border-top-1 px-2 py-4">2. Bahan Kimia tumpah</td>
                                                <td class="border-top-1 px-2 py-4"> 1. terhirup/ terkena kulit</td>
                                                <td class="border-top-1 px-2 py-4"> 
                                                1. Menggunakan APD (safety helmet, rubber gloves, gas masker, safety shoes, face shield, ear plug dan safety clothes) <br>				
                                                2. Persiapkan alat penyerap untuk penanggulangan tumpahan di jalan seperti absorbent				
													
                                                </td>
                                            </tr>

                                            <tr>
                                                <td class="border-top-1 px-2 py-4" rowspan="2">3. Personil tidak kompeten</td>
                                                <td class="border-top-1 px-2 py-4">1. Kesalahan teknik dan efektivitas </td>
                                                <td class="border-top-1 px-2 py-4"> 
                                                1. Penyemprotan dilaksananakan dengan memperhatikan arah angin <br>				
                                                2. Bekerja lebih fokus, personil memiliki ijin / sertifikasi				
													
                                                </td>
                                            </tr>
                                            <tr>
                                            <td class="border-top-1 px-2 py-4">2. Terkena paparan pestisida, digigit serangga </td>
                                                <td class="border-top-1 px-2 py-4"> 
                                                1. Menggunakan APD (safety helmet, rubber gloves, gas masker, safety shoes, face shield, ear plug dan safety clothes) <br>				
                                                2. Pastikan di area kerja tidak ada orang lain yang tidak berkepentingan				
                                                </td>
                                            </tr>

                                            <tr>
                                                <td class="border-top-1 px-2 py-4">4. Ujung fogging berapi</td>
                                                <td class="border-top-1 px-2 py-4">1. Alarm detektor berbunyi</td>
                                                <td class="border-top-1 px-2 py-4"> 
                                                1. Menyediakan peralatan pemadam kebakaran dan tim tanggap darurat siap siaga selama pelaksanaan fogging sampai selesai													
                                                </td>
                                            </tr>

                                            <tr>
                                                <td class="border-top-1 px-2 py-4">5. Mesin  tidak dicek </td>
                                                <td class="border-top-1 px-2 py-4">1. Mesin fogging macet</td>
                                                <td class="border-top-1 px-2 py-4"> 
                                                1. Pastikan alat dalam kondisi layak untuk kerja 																
                                                </td>
                                            </tr>

                                            <tr>
                                                <td class="border-top-1 text-muted px-2 py-4 font-12" rowspan="1">6</td>
                                                <td class="border-top-1 text-muted px-2 py-4 font-12" rowspan="1">Pekerjaan Selesai </td>
                                                <td class="border-top-1 px-2 py-4">1. Sisa bahan kimia  </td>
                                                <td class="border-top-1 px-2 py-4">1. Pencemaran tanah / lingkungan</td>

                                                <td class="border-top-1 px-2 py-4">
                                                1. Masukkan dalam kontainer	<br>		
                                                2. Menggunakan APD (safety helmet, rubber gloves, gas masker, safety shoes, face shield, ear plug dan safety clothes) <br>				
                                                3. Pastikan tidak ada sisa campuran chemical yang dibuang sembarang tempat	<br>			
                                                4. Kumpulkan peralatan kerja dan bahan, jangan sampai ketinggalan				
