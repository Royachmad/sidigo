                ...
                ?>
                        ...
                        <table class="table table-bordered2 table-striped display no-wrap text-muted" style="width:100%; height:100%;">
                            ...
                            <tr>
                                ...
                                <td colspan='2'> 
                                    :Pemeriksaan / Maintenance Jaringan Komputer
                                </td>
                            ...
                            <tr>
                                <td>&nbsp APD</td>
                                <td colspan='2'> 
                                :&nbsp  1.Hand Gloves / Rubber Gloves	<br>		
                                &nbsp  2.Safety Shoes		
                                </td>
                        ...
                        <table class="table table-striped table-bordered2 display no-wrap"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 text-muted px-2 py-4 font-12">Identifikasi instalasi komputer dan telepon melalui drawing</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 text-muted px-2 py-4 font-12" rowspan="2" >Pemeriksaan kondisi fisik peralatan komputer dan telepon</td>
                                            ...
                                            <tr>
                                                ...
                                                2. Sudut dari instalasi yang tajam <br>
                                                 ...
                                                 <td class="border-top-1 px-2 py-4"> 1. Tergores / terluka / terjepit </td>
                                                <td class="border-top-1 px-2 py-4" >
                                                1. Menggunakan pakaian kerja (wearpack), rubber/hand gloves		
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 text-muted px-2 py-4 font-12"  rowspan="3">Maintenance Server </td>
                                                ...
                                                5. Menggunakan rubber gloves, safety shoes				
                                            ...
                                            <tr>
                                                <td class="border-top-1 px-2 py-4">3. Personil tidak kompeten  </td>
                                                <td class="border-top-1 px-2 py-4"> 1.Program terhapus </td>
                                                <td class="border-top-1 px-2 py-4"> 1. Bekerja lebih fokus, personil memiliki ijin / sertifikasi								
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 text-muted px-2 py-4 font-12" rowspan="1">Maintenance kabel RJ45 / Crimping  </td>

                                                <td class="border-top-1 px-2 py-4">1. Gunting Crimping </td>
                                                <td class="border-top-1 px-2 py-4">1. Tergores/Terluka <br> /terjepit </td>

                                                <td class="border-top-1 px-2 py-4">
                                                1. Menggunakan sarung tangan / hand gloves				
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 text-muted px-2 py-4 font-12" rowspan="1">Pemasangan / Maintenance Komputer </td>
