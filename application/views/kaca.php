                        ...
                        <table class="table table-striped table-bordered2 display no-wrap"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 text-muted px-2 py-4 font-12">Persiapan alat</td>

                                                <td class="border-top-1 px-2 py-4"> 1. Alat tidak aman</td>
                                                <td class="border-top-1 px-2 py-4">1. Tertimpa material</td>

                                                <td class="border-top-1 px-2 py-4">1. Memastikan alat sudah aman <br>			
                                                2. Menggunakan APD (safety helmet, rubber gloves, dust masker, safety shoes, body harness )			
                                                </td>
                                            </tr>

                                            <tr>
                                                <td class="border-top-1 text-muted px-2 py-4 font-12" rowspan="5">3</td>

                                                <td class="border-top-1 text-muted px-2 py-4 font-12" rowspan="5" >Penyusunan Konstruksi Scafolding / Gondola</td>

                                                <td class="border-top-1 px-2 py-4"> 
                                                1. bahan,rancangan, dan metode pendirian scaffolding / gondola salah
                                                 </td>
                                                 <td class="border-top-1 px-2 py-4"> 
                                                 1. Scaffolding / gondola jatuh
                                                 </td>
                                                <td class="border-top-1 px-2 py-4" >
                                                1. Membangun konstruksi scafolding / gondola sesuai SOP	<br>	
                                                2. Personil dengan kompetensi scaffolder / gondola dan validasi metode dengan tim safety			
                                                </td>			
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 px-2 py-4"> 
                                                2. Sisi tajam dan berat<br>
                                                 </td>
                                                 <td class="border-top-1 px-2 py-4"> 
                                                 1. Terpleset / tersandung <br>/ terjatuh / tergores
                                                 </td>
                                                <td class="border-top-1 px-2 py-4" >
                                                1. Menggunakan APD (safety helmet, rubber gloves, dust masker, safety shoes, body harness )		
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 px-2 py-4"> 
                                                3. Personil tidak kompeten
                                                 </td>
                                                 <td class="border-top-1 px-2 py-4"> 
                                                 1. Menghambat pekerjaan
                                                 </td>
                                                <td class="border-top-1 px-2 py-4" >
                                                1. Personil harus terlatih / memiliki ijin			
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                5. Area tidak steril
                                                 ...
                                                 <td class="border-top-1 px-2 py-4"> 
                                                 1. Mengganggu proses <br> rehabilitasi
                                                 </td>
                                                <td class="border-top-1 px-2 py-4" >
                                                1. Memasang barikade di area rehabilitasin						
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 text-muted px-2 py-4 font-12"  rowspan="3">Pembersihan kaca gedung </td>

                                                <td class="border-top-1 px-2 py-4">1. Personil tidak kompeten</td>
                                                <td class="border-top-1 px-2 py-4">1. Menghambat pekerjaan</td>

                                                <td class="border-top-1 px-2 py-4"> 
                                                1. Personil harus memiliki ijin / terlatih
                                                </td>						
                                            </tr>

                                            <tr>
                                                <td class="border-top-1 px-2 py-4" rowspan="2">2. Bekerja outdoor di ketinggian </td>
                                                <td class="border-top-1 px-2 py-4">1. Terpleset / tersandung / terjatuh / tergores </td>
                                                <td class="border-top-1 px-2 py-4"> 1. Bekerja dengan fokus dan hati- hati			
                                                    2. Jika memungkinkan, bersihkan terlebih dahulu lokasi kerja agar tidak licin	<br>		
                                                    3. Menggunakan APD (safety helmet, rubber gloves, dust masker, safety shoes, body harness )			
                                                </td>
                                            </tr>
                                            <tr>
                                            <td class="border-top-1 px-2 py-4">2. Terpapar panas matahari / hujan  </td>
                                                <td class="border-top-1 px-2 py-4">1. Mengatur jam kerja dan tidak meneruskan pekerjaan jika cuaca buruk		
                                                </td>
                                            </tr>
