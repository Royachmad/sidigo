                ...
                ?>
                        ...
                        <table class="table table-bordered2 table-striped display no-wrap text-muted" style="width:100%; height:100%;">
                            ...
                            <tr>
                                ...
                                <td colspan='2'> 
                                    : Maintenance Sistem Pemadam Kebakaran
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                &nbsp  5. Safety Glasses, Face shield/Pelindung wajah <br>
                        ...
                        <table class="table table-striped table-bordered2 display no-wrap"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 text-muted px-2 py-4 font-12">Menelaah dan mempelajari berkas sistem proteksi kebakaran, meliputi Akta Ijin, Dokumen fabrikasi, Gambar Instalasi, dan hasil pemeriksaan sebelumnya.</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 text-muted px-2 py-4 font-12" rowspan="3" >Melakukan verifikasi identitas terhadap data-data dan drawing yang mencakup Tag no, no seri dan data pelat nama.</td>

                                                <td class="border-top-1 px-2 py-4"> 
                                                1. Permukaan tidak rata/ stabil  <br>
                                                 </td>
                                                 <td class="border-top-1 px-2 py-4"> 
                                                 1. Terpeleset/ tersandung<br>
                                                 </td>
                                                <td class="border-top-1 px-2 py-4" >
                                            ...
                                            <tr>
                                                ...
                                                2. Sudut dari instalasi yang tajam <br>
                                                 ...
                                                 <td class="border-top-1 px-2 py-4"> 
                                                 1. Tergores/terluka <br>
                                                 /terjepit
                                                 </td>
                                                <td class="border-top-1 px-2 py-4" >
                                                1. Menggunakan pakaian kerja (wearpack), safety helmet, hand gloves, safety shoes, safety glass			
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 px-2 py-4"> 
                                                3. Bekerja pada ketinggian <br>
                                                 </td>
                                                 <td class="border-top-1 px-2 py-4"> 
                                                 1. Terjatuh
                                                 </td>
                                                <td class="border-top-1 px-2 py-4" >
                                                1. Jika menggunakan scaffolding, pastikan telah terdapat tanda aman untuk digunakan (safe for used tag) yang berwarna hijau			
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 text-muted px-2 py-4 font-12"  rowspan="1">Memeriksa kondisi fisik sistem proteksi kebakaran:		
                                                <br> a. Kesesuaian pemasangan instalasi dengan gambar yang telah disyahkan </td>

                                                <td class="border-top-1 px-2 py-4">1. Permukaan tidak rata/ stabil </td>
                                                <td class="border-top-1 px-2 py-4">1. Terpeleset/ tersandung</td>
                                            ...
                                            <tr>
                                                <td class="border-top-1 text-muted px-2 py-4 font-12">b. Kelengkapan instalasi sesuai dengan spesifikasi teknik <br>		
                                                 c. Pemeriksaan terhadap kemungkinan adanya cacat. 		
                                                 </td>
                                                <td class="border-top-1 px-2 py-4">2. Sudut dari instalasi yang tajam </td>
                                                <td class="border-top-1 px-2 py-4">1. Tergores / terluka </td>
                                                <td class="border-top-1 px-2 py-4"> 1. Menggunakan pakaian kerja (wearpack)							
                                                </td>
                                            </tr>

                                            <tr>
                                                <td class="border-top-1 text-muted px-2 py-4 font-12" rowspan="3">5</td>

                                                <td class="border-top-1 text-muted px-2 py-4 font-12" rowspan="1">Menyaksikan pengujian sistem proteksi kebakaran	<br>	
                                                1. Menyaksikan uji instalasi alarm :		
                                                </td>
                                            ...
                                            <tr>
                                                <td class="border-top-1 px-2 py-4">1.1 Periksa indicator pada panel control	<br>	
                                                1.2 Test fungsi kerja sistem dengan menggunakan smoke tester		
                                                </td>
                                                <td class="border-top-1 px-2 py-4">2. Kebisingan melebihi NAB </td>
                                                <td class="border-top-1 px-2 py-4">1. Gangguan pendengaran</td>
                                                <td class="border-top-1 px-2 py-4">
                                                1. Menggunakan earmuff/ earplug			
                                                </td>
                                            </tr>

                                            <tr>
                                                <td class="border-top-1 px-2 py-4">2. Menyaksikan Uji hydrant dan springkler :	<br>	
                                                    2.1 Periksa indicator pada panel control <br>
                                                    2.2 Periksa ruang pompa dan sistem persediaan air	<br>	
                                                    2.3 Test kerja pompa dan catat tekanan		
                                                            
                                                </td>
                                                <td class="border-top-1 px-2 py-4">3. Sudut dari instalasi yang tajam</td>
                                                <td class="border-top-1 px-2 py-4">1.  Tergores/ terluka</td>
                                                <td class="border-top-1 px-2 py-4">
                                            ...
                                            <tr>
                                                <td class="border-top-1 text-muted px-2 py-4 font-12" >6</td>

                                                <td class="border-top-1 text-muted px-2 py-4 font-12">Melakukan pengambilan gambar foto terhadap objek yang diperiksa </td>
