                ...
                ?>
                        ...
                        <table class="table table-bordered2 table-striped display no-wrap text-muted" style="width:100%; height:100%;">
                            ...
                            <tr>
                                ...
                                <td colspan='2'> 
                                    :Pemeriksaan / Maintenance Jaringan Telepon
                                </td>
                        ...
                        <table class="table table-striped table-bordered2 display no-wrap"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 text-muted px-2 py-4 font-12">Identifikasi instalasi telepon melalui drawing</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 text-muted px-2 py-4 font-12" rowspan="2" >Pemeriksaan kondisi fisik peralatan PABX dan pesawat telepon</td>
                                                ...
                                                <td class="border-top-1 px-2 py-4" >
                                                1. Membaca dan menerapkan SOP pekerjaan instalasi listrik - telepon	<br>			
                                                2. Menerapkan prosedur LOTO	<br>			
                                                3. Menggunakan rubber gloves				  
                                                </td>			
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 px-2 py-4" >
                                                1. Menggunakan sarung tangan / hand gloves, safety helmet, safety gloves			
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 text-muted px-2 py-4 font-12"  rowspan="3">Maintenance PABX </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 px-2 py-4"> 1. Tergores/Terluka <br> /terjepit </td>
                                                <td class="border-top-1 px-2 py-4"> 1. Menggunakan sarung tangan/hand gloves, safety helmet, safety shoes										
                                                </td>
                                            </tr>

                                            <tr>
                                                <td class="border-top-1 px-2 py-4">3. Personel tidak Kompeten </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 text-muted px-2 py-4 font-12" rowspan="1">Pemasangan Kabel UTP  </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 text-muted px-2 py-4 font-12" rowspan="1">Pemasangan / Maintenance Pesawat Telepon </td>

                                                <td class="border-top-1 px-2 py-4">1. Aliran listrik </td>
                                                <td class="border-top-1 px-2 py-4">1. Tersetrum</td>
                                                <td class="border-top-1 px-2 py-4">
                                                1. Membaca dan menerapkan SOP pekerjaan instalasi listrik dan telepon <br>			
                                                2. Menerapkan prosedur LOTO	<br>			
                                                3. Pastikan objek pada kondisi aman untuk diperiksa (saat tidak badai petir dan keadaan lokasi basah) <br>				
