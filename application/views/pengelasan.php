                        ...
                        <table class="table table-striped table-bordered2 display no-wrap"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 text-muted px-2 py-4 font-12">Identifikasi denah tempat kerja</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 text-muted px-2 py-4 font-12" rowspan="2" >Fit-up menggunakan chain block</td>
                                                ...
                                                <td class="border-top-1 px-2 py-4" >
                                                1. Melakukan safety talk/tool box meeting sebelum pekerjaan dimulai.			
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 px-2 py-4"> 
                                                2. Material jatuh pada saat pengangkatan  <br>
                                                 </td>
                                                 <td class="border-top-1 px-2 py-4"> 1. Terjepit, tertimpa bahkan fatality.</td>
                                                <td class="border-top-1 px-2 py-4" >
                                                1. Menggunakan alat pelindung diri (APD) yang lengkap sesuai pekerjaan. <br>				
                                                2. Inspeksi peralatan sebelum digunakan. <br>				
                                                3. Pemasangan rambu dan peralatan K3 lainnya yang membantu pelaksanaan pekerjaan.				
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 text-muted px-2 py-4 font-12"  rowspan="2">Fit-up menggunakan tangga lipat</td>

                                                <td class="border-top-1 px-2 py-4">1. Tangga lipat  tidak berfungsi  </td>
                                                <td class="border-top-1 px-2 py-4"> 1. Pekerjaan tertunda </td>

                                                <td class="border-top-1 px-2 py-4"> 
                                                1. Bekerja dengan fokus dan hati- hati	<br>			
                                                2. Inspeksi peralatan sebelum digunakan.												
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 px-2 py-4">2. Sling putus dan tangga lipat terjungkit menimpa pekerja  </td>
                                                <td class="border-top-1 px-2 py-4">1. Terjepit, tertimpa bahkan fatality.</td>
                                                <td class="border-top-1 px-2 py-4"> 1. Menggunakan alat pelindung diri (APD) yang lengkap sesuai pekerjaan. <br>				
                                                    2. Inspeksi peralatan sebelum digunakan.														
                                                </td>
                                            </tr>

                                            <tr>
                                                <td class="border-top-1 text-muted px-2 py-4 font-12" rowspan="5">5</td>

                                                <td class="border-top-1 text-muted px-2 py-4 font-12" rowspan="5">Pengelasan  </td>

                                                <td class="border-top-1 px-2 py-4">1. Fume, gas beracun (ISPA) </td>
                                                <td class="border-top-1 px-2 py-4">1. Terhirup / terkena kulit </td>

                                                <td class="border-top-1 px-2 py-4">
                                                1. Menggunakan alat pelindung diri (APD) yang lengkap sesuai pekerjaan				
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="border-top-1 px-2 py-4">2. Radiasi panas dan cahaya yang berlebihan serta percikan las dan pemotongan pipa </td>
                                                <td class="border-top-1 px-2 py-4"> 1. Iritasi mata, kulit terbakar dan kebakaran </td>
                                                <td class="border-top-1 px-2 py-4">
                                                1. Menggunakan alat pelindung diri (APD) yang lengkap sesuai pekerjaan	<br>			
                                                2. Proteksi area kerja	<br>
                                                3. Pekerja dalam kondisi badan sehat dan fit				
                                                </td>
                                            </tr>

                                            <tr>
                                                <td class="border-top-1 px-2 py-4">3. Aliran listrik</td>
                                                <td class="border-top-1 px-2 py-4"> 1. Tersetrum</td>
                                                <td class="border-top-1 px-2 py-4">
                                                1. Pemasangan rambu dan peralatan K3 lainnya yang membantu pelaksanaan pekerjaan <br>				
                                                2. Jaga kabel pengelasan bebas dari air/lantai yang basah. <br>
                                                3. Menerapkan prosedur LOTO	<br>			
                                                4. Menggunakan alat pelindung diri (APD) yang lengkap sesuai pekerjaan.				
                                                </td>
                                            </tr>

                                            <tr>
                                                <td class="border-top-1 px-2 py-4">4. Kebocoran gas  </td>
                                                <td class="border-top-1 px-2 py-4"> 1. Ledakan dan kebakaran</td>
                                                <td class="border-top-1 px-2 py-4">
                                                1. Sosialisasi MSDS keseluruh pekerja <br>				
                                                2. Pemasangan grounding yang baik dan benar.	<br>			
                                                3. Penyediaan alat pemadam api ringan (APAR). <br>		
                                                4. Pemasangan barrier pada pekerjaan pengelasan	<br>			
                                                5. Menggunakan alat pelindung diri (APD) yang lengkap sesuai pekerjaan.	<br>			
                                                6. Larangan merokok pada area penyimpanan tabung gas				
				
                                                </td>
                                            </tr>

                                            <tr>
                                                <td class="border-top-1 px-2 py-4">5. Limbah kawat las  </td>
                                                <td class="border-top-1 px-2 py-4"> 1. Pencemaran lingkungan </td>
                                                <td class="border-top-1 px-2 py-4">
                                                1. Menyediakan tempat penampungan limbah B3 kawat las <br>				
                                                2. Pembersihan lokasi kerja pengelasan setelah pekerjaan selesai				
                                                </td>
                                            </tr>
