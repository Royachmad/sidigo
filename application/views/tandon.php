                        ...
                        <table class="table table-striped table-bordered2 display no-wrap"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                2. Menggunakan APD (safety helmet, rubber gloves, gas masker, safety shoes, safety glasses dan safety clothes)		
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 text-muted px-2 py-4 font-12" rowspan="4" >Rehabilitasi Tandon / Tangki Air</td>

                                                <td class="border-top-1 px-2 py-4"> 
                                                1. Saluran pembuangan air buruk
                                                 </td>
                                                 <td class="border-top-1 px-2 py-4"> 
                                                 1. Banjir / air tersebar kemana - mana dan tidak terkontrol   
                                                 </td>
                                                <td class="border-top-1 px-2 py-4" >
                                                1. Membuat plan pengosongan tandon / tangki	<br>		
                                                2. Memastikan saluran air baik dan tidak tersumbat									
                                                </td>			
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                2. Area tidak steril
                                                 ...
                                                 <td class="border-top-1 px-2 py-4"> 
                                                 1. Mengganggu proses rehabilitasi
                                                 </td>
                                                <td class="border-top-1 px-2 py-4" >
                                                1. Memasang barikade di area rehabilitasi	
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-1 text-muted px-2 py-4 font-12"  rowspan="2">Desinfektan Tandon / Tangki Air </td>

                                                <td class="border-top-1 px-2 py-4">1. Salah perhitungan kadar klorin </td>
                                                <td class="border-top-1 px-2 py-4">1. Air menjadi tercemar klorin yang berlebihan</td>

                                                <td class="border-top-1 px-2 py-4"> 
                                                1. Memperhitungkan jumlah klorin secara akurat berdasarkan volume air
                                                </td>						
                                            </tr>

                                            <tr>
                                                <td class="border-top-1 px-2 py-4">2.Terpajan bahan kimia cat</td>
                                                <td class="border-top-1 px-2 py-4">1. Terhirup/ terkena kulit </td>
                                                <td class="border-top-1 px-2 py-4"> 2. Menggunakan APD (safety helmet, rubber gloves, dust masker, safety shoes)			
                                                <br> 2. Lakukan desinfektan dengan hati - hati							
                                                </td>
                                            </tr>

                                            <tr>
                                                <td class="border-top-1 text-muted px-2 py-4 font-12" >5</td>

                                                <td class="border-top-1 text-muted px-2 py-4 font-12" >Tahap Tes Klorin </td>

                                                <td class="border-top-1 px-2 py-4">1. Salah perhitungan kadar klorin  </td>
                                                <td class="border-top-1 px-2 py-4">1. Air menjadi tercemar klorin yang berlebihan</td>

                                                <td class="border-top-1 px-2 py-4"> 
                                                1. Apabila konsentrasi klorin lebih dari 0.5 mg/liter , maka kosongkan tangki lagi dan isi dengan air bersih.lakukan terus hingga kandungannya kurang dari 0.5mg/ setara
                                                </td>						
                                            </tr>
